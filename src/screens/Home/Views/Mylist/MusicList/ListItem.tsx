...
import { isTV, TV_STYLES } from '@/config/tv'
...
export default memo(
  ({
    ...
    const listItemStyle = isTV ? StyleSheet.compose(
      styles.listItem,
      TV_STYLES.listItem,
      { width: rowInfo.rowWidth, height: Math.max(ITEM_HEIGHT, TV_STYLES.listItem.minHeight) }
    ) : {
      ...styles.listItem,
