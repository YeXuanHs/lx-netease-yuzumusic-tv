...
import { loadBuiltinSources, loadOnlineSources } from '@/core/builtinSources'
...
export default async () => {
  ...
  const builtinSourceCount = await loadBuiltinSources()
  bootLog(`Builtin sources loaded: ${builtinSourceCount}`)

  const onlineSourceCount = await loadOnlineSources()
  bootLog(`Online sources loaded: ${onlineSourceCount}`)
